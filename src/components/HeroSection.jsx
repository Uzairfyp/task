  ...
  return (
    <section className="bg-[#f9f4f7]">
      <div className="text-gray-900 px-4 pt-16 pb-12">
        ...
        <div className="relative w-full flex justify-center mb-10 h-64 sm:h-80 md:h-96">
        ...
        {/* Stats Section */}
        <div className="bg-white text-gray-900 rounded-2xl px-6 py-8 max-w-6xl mx-auto w-full shadow-md mt-10 mb-16 relative right-0 sm:right-[-4rem] md:right-[-16rem]">
